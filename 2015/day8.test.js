...
describe('Day 8 - Part 1', () => {
	describe('Example 1', () => {
		it('should return the string chars', () => {
			expect(part1([""])).toBe(2);
		});
	});
	...
	describe('Example 2', () => {
		it('should return the string chars', () => {
			expect(part1(["abc"])).toBe(2);
		});
	});

	describe('Example 3', () => {
		it('should return the string chars', () => {
			expect(part1(["aaa\"aaa"])).toBe(2);
		});
	});

	describe('Example 4', () => {
		it('should return the string chars', () => {
			expect(part1(["\x27"])).toBe(2);
		});
	});
...
// 	describe('Example 1', () => {
// 		it('should return the states of the wires', () => {
// 			expect(part2(
// 				[
// 					'123 -> x',
// 					'456 -> y',
